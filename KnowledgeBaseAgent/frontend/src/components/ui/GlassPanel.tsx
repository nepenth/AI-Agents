    ...
    variants: {
      variant: {
        primary: [
          ...
          'hover:shadow-glass-secondary hover:border-glass-border-secondary',
        ...
        secondary: [
          ...
          'hover:shadow-glass-primary hover:border-glass-border-primary',
        ...
        navbar: [
          'bg-glass-navbar border-glass-border-navbar shadow-glass-navbar backdrop-blur-xl',
          'sticky top-0 z-40',
        ...
        interactive: [
          ...
          'hover:shadow-glass-interactive-hover hover:scale-[1.02] cursor-pointer',
          'active:scale-[0.98] transition-transform',
          'before:absolute before:inset-0 before:bg-gradient-to-br before:from-white/8 before:to-transparent before:pointer-events-none'
        ],
        overlay: [
          'bg-glass-overlay border-glass-border-overlay shadow-glass-overlay backdrop-blur-2xl',
